        ...
        for img_ind_1 in [4, 5]:
            ...
            for img_ind_2 in indexes:
                ...
                if folder_1 >= 30:
                    ...
                    prism_num = '3400-0.08'
                yield folder_name + str(folder_1) + '-' + '49-' + prism_num + '-0.03/z' + str(img_ind_1) + '.' + str(img_ind_2) + '.png'


for img_name in name_files_30_density():
    print(img_name)
    ...
    if amount_images % 20 == 1:
        cv.imwrite(f'30_density_images/{amount_images}_segmented.png', img)
        cv.imwrite(f'30_density_images/{amount_images}.png', img_new)
...
plot_hist(angle_dist, all_angle_amount, 'angle_distribution', '30_density_distributions')
plot_hist(area_dist, all_grains_amount, 'area_distribution', '30_density_distributions')
