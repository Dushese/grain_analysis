...
for folder_1 in range(10, 20, 10):
    for img_ind_1 in [4, 5]:
        ...
        for img_ind_2 in indexes:
            ...
            if folder_1 >= 30:
                ...
                prism_num = '3400-0.08'
            img_name = folder_name + str(folder_1) + '-' + '49-' + prism_num + '-0.03/z' + str(
...
plot_hist(angle_dist, all_angle_amount, 'angle_distribution', 30)
plot_hist(area_dist, all_grains_amount, 'area_distribution', 30)
